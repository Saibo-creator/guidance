from guidance._grammar import GenRegexTerminalRule, JoinRule, GrammarObject, string, capture
...
class TestGrammarRules:
    ...
    def test_grammar_rule_auto_naming(self):
        ...
        # Reset the counter
        GrammarObject.num_used_names = 0

        new_rule_name = GrammarObject._new_name()
        assert new_rule_name == "a", f"Expected new name 'a', got {new_rule_name}"
        assert GrammarObject.num_used_names == 1, f"Expected 1 used name, got {GrammarObject.num_used_names}"
